                    ...
                    <form class="p-3">
                        <div class="form-group m-0">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Pesquise" aria-label="Recipient's username">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    @if (Auth::user()->url_photo)
                        <img class="rounded-circle header-profile-user" src="{{ url("storage/UsersPhotos/".Auth::user()->url_photo) }}"
                        alt="Header Avatar">
                    @endif
