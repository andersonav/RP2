...
@section('page-title')
    <h4> Alterar Equipamentos/Referências </h4>
@endsection
@section('page-title-right')
    <ol class="breadcrumb m-0">
        <li class="breadcrumb-item"> <a href="#"> Início </a> </li>
        <li class="breadcrumb-item"> <a href="/tiposEquipamentos/index"> Equipamentos/Referências </a> </li>
        <li class="breadcrumb-item" class="active"> <a href="#"> Editar Equipamentos/Referências </a> </li>
    </ol>
@endsection
@section('content')
<style>
    ...
    <input type="hidden" id="idTipoEquipamento" value="{{ $equipamentoModelo->id }}" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipo">
                                                <option value="equipment" {{ $equipamentoModelo->tipo === 'equipment' ? 'selected' : '' }}>Equipamento</option>
                                                <option value="reference" {{ $equipamentoModelo->tipo === 'reference' ? 'selected' : '' }}>Referência</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nome_modelo"
                                                value="{{ $equipamentoModelo->nome_modelo }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                             ...
                                             rows="5"
                                            >{{ $equipamentoModelo->descricao_modelo}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="box-content-laudo">
                                            <textarea id="textAreaContent" name="data_html">
                                                {{str_replace('../storage/','../../storage/', $equipamentoModelo->data_html)}}
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
